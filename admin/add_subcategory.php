...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Category\Add Sub-category\<a href="manage_subcategory.php">Manage Sub-category</a></h4>
...
<div class="col-md-5">
		<div class="panel panel-info">
			...
			<center>
			<table>
				<form role="form" method="post" action="processsubcat.php">
...
?>
				...
				<div class="form-group">
				<tr>
				<td><label>Subcatgory Name</label></td>
				<td><input name="subcat" type="text" id="subcat"> </td>
				</tr></div>

				<div class="form-group">
				<tr>
				<td><label>Subcatgory Link</label></td>
				<td><input name="subcatlink" type="text" id="subcat"></td>
				</tr></div>
				<div class="form-group">
				<tr>
	...
	{       
        while($row = mysqli_fetch_array( $result )) {	?>
			<tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php echo $row['subcat_id'];?></td>
