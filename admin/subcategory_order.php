...
?>
				...
				<div class="panel panel-info">
					<div class="panel-heading" align="center">Report of Order Subcategory Wise</div>
	...
	<?php
        ...
        include("includes/config.php");
			...
			$cat=$_POST['cat'];
			$subcat=$_POST['subcat'];			
			$sql="SELECT * FROM tblcat,tblsubcat,tblitem,tblorder where tblcat.cat_id =tblsubcat.cat_id and tblitem.item_subcat=tblsubcat.subcat_id  and tblcat.cat_id='$cat'and tblsubcat.subcat_id='$subcat' and tblorder.i_id=tblitem.itemid and tblitem.item_cat=tblcat.cat_id  ORDER BY tblorder.order_id ASC";
			//echo$sql;
			$result = mysqli_query($conn,$sql); 
             $cnt=1;
