...
<head>
    ...
    <title>Yearly Report of Order</title>
...
<!-- MENU SECTION END-->
            ...
            <div class="col-md-12">
			 ...
			 <div class="col-md-5">
				...
				<div class="panel panel-info">
					<div class="panel-heading" align="center">Yearly Report of Order</div>
	...
	<?php
        ...
        include("includes/config.php");
			...
			$year=$_POST['year'];
			$sql="SELECT * FROM tblorder,tblusers,tblitem where tblorder.c_id =tblusers.userid and tblitem.itemid=tblorder.i_id and year( o_date )='$year'";
