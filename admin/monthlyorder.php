...
<head>
    ...
    <title>Monthly Report of  Order</title>
...
<!-- MENU SECTION END-->
            ...
            <div class="col-md-12">
			 ...
			 <div class="col-md-5">
				...
				<div class="panel panel-info">
					<div class="panel-heading" align="center">Monthly Report of Order</div>
	...
	<?php
        ...
        include("includes/config.php");
			...
			$month=$_POST['month'];
			$sql="SELECT * FROM tblorder,tblusers,tblitem where tblorder.c_id =tblusers.userid and tblitem.itemid=tblorder.i_id and month( o_date )='$month'";
