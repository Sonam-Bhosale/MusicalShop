...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
         <div class="container">
            ...
            <div class="col-md-12">
			 <h4 class="header-line">Reports\Products\<a href="dailyproduct.php">Daily</a>\<a href="datewiseproduct.php">DateWise</a>\<a href="weeklyproduct.php">Weekly</a>\<a href="dateinbetweenproduct.php">Date in Between</a>\<a href="monthlyproduct.php">Monthly</a>\<a href="yearlyproduct.php">Yearly</a>\<a href="views.php">Product Views</a></h4> 
			 </div>
			 </div>
			 <!---<div class="row">
