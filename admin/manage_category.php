...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
         <div class="container">
            ...
            <div class="col-md-12">
			 <h4 class="header-line">Category\<a href="add_category.php">Add Category</a>\Manage Categories</h4> 
			 </div>
			 </div>
        ...
        while($row = mysqli_fetch_array( $result )) {	?>
			<tr class="odd gradeX">
                         <td class="center" align="center"><?php echo htmlentities($cnt);?></td>
                          <td class="center" align="center"><?php echo $row['cat_id'];?></td>
                                            
                          <td class="center"><?php echo $row['cat_name'];?></td>
                         <td class="center"><?php echo $row['detail'];?></td>
						<td class="center" align="center">

                         <a href="edit_category.php?id=<?php echo $row['cat_id'];?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> Edit</button> 
                         <a href="deletecategory.php?id=<?php echo$row['cat_id'];?>">  <button class="btn btn-danger"><i class="fa fa-pencil"></i> Delete</button>
                                            </td>
                                        </tr>
										<?php $cnt=$cnt+1;}} ?>                                      
                                    </tbody>
