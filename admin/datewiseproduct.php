...
<head>
    ...
    <title>DateWise Report of  Products</title>
...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
         <div class="container">
            ...
            <div class="col-md-12">
			 <h4 class="header-line">Reports\<a href="productreport.php">Products</a>\DateWise\<a href="weeklyproduct.php">Weekly</a>\<a href="dateinbetweenproduct.php">Date in Between</a>\<a href="monthlyproduct.php">Monthly</a>\<a href="yearlyproduct.php">Yearly</a>\<a href="views.php">Product Views</a></h4> 
			 </div>
			 </div>
			 <div class="row">
			 ...
			 <div class="col-md-5">
				...
				<div class="panel panel-info">
					<div class="panel-heading" align="center">Datewise Report of Product</div>
