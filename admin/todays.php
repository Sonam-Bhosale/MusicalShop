...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
         <div class="container">
            ...
            <div class="col-md-12">
			 <h4 class="header-line">Order\Todays Order\<a href="confirmed.php">Confirm Order</a>\<a href="pending.php">Pending Order</a>\<a href="delivered.php">Deliver Order</a></h4> 
			 </div>
			 </div>
				<div class="panel panel-info">
					<div class="panel-heading">List of Todays Order</div>
	...
	<?php
		...
		$sql="SELECT * FROM tblorder,tblusers,tblitem where tblorder.c_id =tblusers.userid and tblitem.itemid=tblorder.i_id AND tblorder.o_date between '$from' and '$to' ORDER BY tblorder.order_id ASC";
