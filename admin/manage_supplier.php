...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
         <div class="container">
            ...
            <div class="col-md-12">
			 <h4 class="header-line">Supplier\<a href="add_supplier.php">Add New Supplier</a>\Manage Supplier</h4> 
			 </div>
			 </div>
        ...
        while($row = mysqli_fetch_array( $result )) {	?>
			<tr class="odd gradeX">
                         <td class="center" align="center"><?php echo htmlentities($cnt);?></td>
                          <td class="center" align="center"><?php echo $row['s_id'];?></td>
						...
						<td class="center" align="center">
                          ...
                          <a href="addnewitem.php?id=<?php echo$row['s_id'];?>">  <button class="btn btn-danger"><i class="fa fa-pencil"></i> Add</button>
                         <a href="deletesupplier.php?id=<?php echo$row['s_id'];?>">  <button class="btn btn-danger"><i class="fa fa-pencil"></i> Delete</button>
                                            </td>
                                        </tr>
										<?php $cnt=$cnt+1;}} ?>                                      
                                    </tbody>
