...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
         <div class="container">
            ...
            <div class="col-md-12">
			 <h4 class="header-line">Products\<a href="add_product.php">Add Product</a>\<a href="manage_product.php">Manage Product</a>\Category wise\<a href="subcategory_product.php">Subcategory Wise Product</a></h4> 
			 </div>
			 </div>
			 <div class="row">
...
?>
	...
	<?php
        ...
        include("includes/config.php");
			...
			$sql="SELECT * FROM tblcat,tblsubcat,tblitem where tblcat.cat_id =tblsubcat.cat_id and tblitem.item_subcat=tblsubcat.subcat_id  and tblcat.cat_id='$cat' ORDER BY tblitem.itemid ASC";
			$result = mysqli_query($conn,$sql); 
             $cnt=1;
