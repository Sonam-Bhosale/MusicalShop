...
<head>
    ...
    <title>Weekly Report of  Order</title>
...
<!-- MENU SECTION END-->
	...
	<?php
		...
		//$sql="select * from tblorder where o_date >= DATE_SUB(CURDATE(), INTERVAL 7 DAY)";
		$sql="SELECT * FROM tblorder,tblusers,tblitem where tblorder.c_id =tblusers.userid and tblitem.itemid=tblorder.i_id and tblorder.o_date>= DATE_SUB(CURDATE(), INTERVAL 7 DAY) ORDER BY tblorder.order_id ASC";
